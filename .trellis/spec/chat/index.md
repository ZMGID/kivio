...
| [Explicit artifact presentation](./artifact-presentation.md) | Kivio-owned artifact IDs, native `present_artifacts` display anchor, hidden-by-default rendering, legacy no-ID compatibility, and MCP spoof prevention | 07-11-explicit-file-presentation |
