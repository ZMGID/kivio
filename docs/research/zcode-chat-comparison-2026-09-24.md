...
更新：2026-09-25。本文统一收录 ZCode 加载、滚动、渲染与附件调查，以及 Kivio 实施、修复和复核记录；后续研究和进展在这里更新。
...
**证据口径：第 3～8 节保留实施前的源码对照和建议，不代表当前仍缺失这些能力。最新对照是第 13 节，审阅版本为 `b0b6c7e4`；第 9～12 节保留实施与修复历史，第 10 节的阅读位置缺陷已在第 11 节修复。没有两款应用的同场景性能比较；本轮只使用合成会话。**
